...
class ChildHelper {
     ...
     *
     * @param child  ProfileView to hide.
     */
    ...
    /**
     * Removes the provided ProfileView from underlying RecyclerView.
     *
    ...
    void removeView(View view) {
        ...
        if (DEBUG) {
            Log.d(TAG, "remove ProfileView off:" + index + "," + this);
        }
    }
    ...
    /**
     * Returns whether a ProfileView is visible to LayoutManager or not.
     *
     * @param view The child view to check. Should be a child of the Callback.
     * @return True if the ProfileView is not visible to LayoutManager
     */
     ...
     *
     * @param view The hidden ProfileView to unhide
     */
     ...
     *
     * @param view The view to remove.
     * @return True if the ProfileView is found and it is hidden. False otherwise.
     */
