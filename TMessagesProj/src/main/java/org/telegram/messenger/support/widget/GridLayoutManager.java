...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        for (int i = 0; i < count; i++) {
            ...
            // We calculate everything with ProfileView's bounding box (which includes decor and margins)
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        /**
         * Returns the current span index of this ProfileView. If the ProfileView is not laid out yet, the return
         ...
         * <p>
         * If the ProfileView occupies multiple spans, span with the minimum index is returned.
         *
         * @return The span index of the ProfileView.
         */
        ...
        /**
         * Returns the number of spans occupied by this ProfileView. If the ProfileView not laid out yet, the
         * return value is <code>undefined</code>.
         *
         * @return The number of spans occupied by this ProfileView.
         */
