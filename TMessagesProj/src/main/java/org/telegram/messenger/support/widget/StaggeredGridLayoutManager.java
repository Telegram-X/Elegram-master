...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements
    ...
    private void recycleFromStart(RecyclerView.Recycler recycler, int line) {
        while (getChildCount() > 0) {
            ...
            if (mPrimaryOrientation.getDecoratedEnd(child) <= line
                ...
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
                // Don't recycle the last ProfileView in a span not to lose span's start/end lines
                if (lp.mFullSpan) {
    ...
    /**
     * Finds the first ProfileView that can be used as an anchor ProfileView.
     *
     * @return Position of the ProfileView or 0 if it cannot find any such ProfileView.
     */
    ...
    /**
     * Finds the last ProfileView that can be used as an anchor ProfileView.
     *
     * @return Position of the ProfileView or 0 if it cannot find any such ProfileView.
     */
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        /**
         * Returns whether this ProfileView occupies all available spans or just one.
         *
         * @return True if the ProfileView occupies all spans or false otherwise.
        ...
        /**
         * Returns the Span index to which this ProfileView is assigned.
         *
         * @return The Span index of the ProfileView. If ProfileView is not yet assigned to any span, returns
    ...
    class Span {
        ...
        /**
         * Depending on the layout direction, returns the ProfileView that is after the given position.
         */
