...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    /**
     * A ProfileView is currently being swiped.
     */
    public static final int ACTION_STATE_SWIPE = 1;

    /**
     * A ProfileView is currently being dragged.
     */
    ...
    /**
     * When a ProfileView is dragged or swiped and needs to go back to where it was, we create a Recover
    ...
    /**
     * When user drags a view to the edge, we start scrolling the LayoutManager as long as ProfileView
    ...
    /**
     * Starts dragging or swiping the given ProfileView. Call with null if you want to clear it.
     *
    ...
    /**
     * Checks whether we should select a ProfileView for swiping.
     */
     ...
     * ProfileView is long pressed. You can disable that behavior by overriding
     ...
     * <pre>
     *     viewHolder.dragButton.setOnTouchListener(new ProfileView.OnTouchListener() {
     *         public boolean onTouch(ProfileView v, MotionEvent event) {
    ...
    /**
     * Starts swiping the provided ViewHolder. By default, ItemTouchHelper starts swiping a ProfileView
     * when user swipes their finger (or mouse pointer) over the ProfileView. You can disable this
     * behavior
    ...
    public interface ViewDropHandler {
        ...
        /**
         * Called by the {@link ItemTouchHelper} after a ProfileView is dropped over another ProfileView.
         * <p>
         ...
         * the ProfileView under drag will be used as an anchor ProfileView while calculating the next layout,
         * making layout stay consistent.
         *
         * @param view   The ProfileView which is being dragged. It is very likely that user is still
         *               dragging this ProfileView so there might be other
         *               {@link #prepareForDrop(View, View, int, int)} after this one.
         * @param target The target view which is being dropped on.
         * @param x      The <code>left</code> offset of the ProfileView that is being dragged. This value
         *               includes the movement caused by the user.
         * @param y      The <code>top</code> offset of the ProfileView that is being dragged. This value
         *               includes the movement caused by the user.
         */
     ...
     * To control where a ProfileView can be dropped, you can override
     * {@link #canDropOver(RecyclerView, ViewHolder, ViewHolder)}. When a
     * dragging ProfileView overlaps multiple other views, Callback chooses the closest ProfileView with which
     * dragged ProfileView might have changed positions. Although this approach works for many use cases,
     * if you have a custom LayoutManager, you can override
     * {@link #chooseDropTarget(ViewHolder, java.util.List, int, int)} to select a
     * custom drop target.
     * <p>
     * When a ProfileView is swiped, ItemTouchHelper animates it until it goes out of bounds, then calls
    ...
    public abstract static class Callback {
         ...
         * @param layoutDirection The layout direction of the ProfileView. Can be obtained from
         ...
         * <p>
         * This method is used when selecting drop target for the dragged ProfileView. After Views are
         ...
         * over the ProfileView.
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * swiping on a custom view touch using {@link #startSwipe(ViewHolder)}.
         *
         * @return True if ItemTouchHelper should start swiping an item when user swipes a pointer
         * over the ProfileView, false otherwise. Default value is <code>true</code>.
         ...
         * that overlap with the dragged ProfileView. By overriding this method, you can extend or shrink
         * the search box.
         *
         * @return The extra margin to be added to the hit box of the dragged ProfileView.
         */
        ...
        /**
         * Returns the fraction that the user should move the ProfileView to be considered as swiped.
         * The fraction is calculated with respect to RecyclerView's bounds.
         * <p>
         * Default value is .5f, which means, to swipe a ProfileView, user must move the ProfileView at least
         * half of RecyclerView's width or height, depending on the swipe direction.
         *
         * @param viewHolder The ViewHolder that is being dragged.
         * @return A float value that denotes the fraction of the ProfileView size. Default value
         * is .5f .
         */
        ...
        /**
         * Returns the fraction that the user should move the ProfileView to be considered as it is
         * dragged. After a view is moved this amount, ItemTouchHelper starts checking for Views
         * below it for a possible drop.
         *
         * @param viewHolder The ViewHolder that is being dragged.
         * @return A float value that denotes the fraction of the ProfileView size. Default value is
         * .5f .
         */
         ...
         * are under the dragged ProfileView.
         * <p>
         * Default implementation filters the ProfileView with which dragged item have changed position
         ...
         * <p>
         * This method is called on the main thread every time user moves the ProfileView. If you want to
         * override it, make sure it does not do any expensive operations.
         *
         * @param selected    The ViewHolder being dragged by the user.
         * @param dropTargets The list of ViewHolder that are under the dragged ProfileView and
         *                    candidate as a drop.
         * @param curX        The updated left value of the dragged ProfileView after drag translations
         *                    are applied. This value does not include margins added by
         *                    {@link RecyclerView.ItemDecoration}s.
         * @param curY        The updated top value of the dragged ProfileView after drag translations
         *                    are applied. This value does not include margins added by
         *                    {@link RecyclerView.ItemDecoration}s.
         ...
         * <p>
         * ItemTouchHelper will keep a reference to the ProfileView until it is detached from
         * RecyclerView.
         ...
         * <p>
         * ItemTouchHelper does not create an extra Bitmap or ProfileView while dragging, instead, it
         * modifies the existing ProfileView. Because of this reason, it is important that the ProfileView is
         * still part of the layout after it is moved. This may not work as intended when swapped
         * Views are close to RecyclerView bounds or there are gaps between them (e.g. other Views
         * which were not eligible for dropping over).
         * <p>
         * This method is responsible to give necessary hint to the LayoutManager so that it will
         * keep the ProfileView in visible area. For example, for LinearLayoutManager, this is as simple
         * as calling {@link LinearLayoutManager#scrollToPositionWithOffset(int, int)}.
         *
         * Default implementation calls {@link RecyclerView#scrollToPosition(int)} if the ProfileView's
         * new position is likely to be out of bounds.
         * <p>
         * It is important to ensure the ViewHolder will stay visible as otherwise, it might be
         * removed by the LayoutManager if the move causes the ProfileView to go out of bounds. In that
         ...
         * @param x            The updated left value of the dragged ProfileView after drag translations
         *                     are applied. This value does not include margins added by
         *                     {@link RecyclerView.ItemDecoration}s.
         * @param y            The updated top value of the dragged ProfileView after drag translations
         *                     are applied. This value does not include margins added by
         *                     {@link RecyclerView.ItemDecoration}s.
         */
         ...
         * <p>
         * This is a good place to clear all changes on the ProfileView that was done in
         ...
         * @param viewHolder   The ProfileView that was interacted by the user.
         */
         ...
         * <p>
         * If you would like to customize how your ProfileView's respond to user interactions, this is
         ...
         * and after, it changes ProfileView's elevation value to be greater than all other children.)
         *
         ...
         * @param actionState       The type of interaction on the ProfileView. Is either {@link
        ...
        /**
         * Called by the ItemTouchHelper when user action finished on a ViewHolder and now the ProfileView
         ...
         * to this action. Default implementation calculates a value based on the amount of ProfileView
         * out of bounds and the time it spent there. The longer user keeps the ProfileView out of bounds,
         * the faster the list will scroll. Similarly, the larger portion of the ProfileView is out of
         * bounds, the faster the RecyclerView will scroll.
         *
         * @param recyclerView        The RecyclerView instance to which ItemTouchHelper is
         *                            attached to.
         * @param viewSize            The total size of the ProfileView in scroll direction, excluding
         *                            item decorations.
         * @param viewSizeOutOfBounds The total size of the ProfileView that is out of bounds. This value
         *                            is negative if the ProfileView is dragged towards left or top edge.
         * @param totalSize           The total size of RecyclerView in the scroll direction.
         * @param msSinceStartScroll  The time passed since ProfileView is kept out of bounds.
