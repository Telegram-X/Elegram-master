...
import static org.telegram.messenger.support.widget.RecyclerView.VERBOSE_TRACING;
...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
     ...
     * It is calculated by checking {@link #getReverseLayout()} and ProfileView's layout direction.
     ...
     * @return A ProfileView that can be used an an anchor ProfileView.
     */
    ...
    static class LayoutState {
         ...
         *
         * @return ProfileView if an item in the current position or direction exists if not null.
         */
