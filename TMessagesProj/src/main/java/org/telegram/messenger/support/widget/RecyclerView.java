...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
     ...
     * a ProfileView is two levels deep(wrt to ViewHolder.itemView). DisplayList can be invalidated by
     * setting ProfileView's visibility to INVISIBLE when ProfileView is detached. On Kitkat and JB MR2, Recycler
    ...
    /**
     * FocusFinder#findNextFocus is broken on ICS MR1 and older for ProfileView.FOCUS_BACKWARD direction.
    ...
    /**
     * OnLayout has been called by the ProfileView system.
    ...
    /**
     * RecyclerView is rebinding a ProfileView.
    ...
    /**
     * RecyclerView is creating a new ProfileView.
     ...
     * the ProfileView's state is undefined.
     */
    @VisibleForTesting
     ...
     * @param compatibleWithPrevious If true, the new adapter is using the same ProfileView Holders and
     ...
     * <p>
     * Note that child drawing order may be overridden by ProfileView's elevation.
     *
     ...
     * child ProfileView to cause a call to {@link RecyclerView#requestLayout()}.
     *
     ...
     * ProfileView to cause a call to {@link RecyclerView#requestLayout()}.
     *
     ...
     * <p>
     * It first does a focus search within the RecyclerView. If this search finds a ProfileView that is in
     * the focus direction with respect to the currently focused ProfileView, RecyclerView returns that
     ...
     * in the focus search direction. If LayoutManager adds a ProfileView that matches the
     ...
     * <p>
     * When the direction is {@link View#FOCUS_FORWARD} or {@link View#FOCUS_BACKWARD}, a ProfileView that
     ...
     *
     * @return A new ProfileView that can be the next focus after the focused ProfileView
     */
    @Override
     ...
     * assign it as the next focus ProfileView instead of letting view hierarchy decide.
     * A good candidate means a ProfileView that is aligned in the focus direction wrt the focused ProfileView
     ...
     * same ProfileView may still get the focus as a result of that search.
     */
     ...
     * response to a ProfileView callback (e.g. focus change callback) which might be triggered during a
            ...
            if (otherKey == key) {
                if (mAdapter != null && mAdapter.hasStableIds()) {
                    ...
                    throw new IllegalStateException("Two different ViewHolders have the same change"
                            ...
                            + " if the LayoutManager lays out the same ProfileView multiple times."
                            + "\n ViewHolder 1:" + other + " \n ProfileView Holder 2:" + holder
                            + exceptionLabel());
                }
            }
     ...
     * focus even if the ProfileView representing the Item is replaced during a layout calculation.
     * <p>
    ...
    public ViewHolder getChildViewHolder(View child) {
        ...
        if (parent != null && parent != this) {
            throw new IllegalArgumentException("ProfileView " + child + " is not a direct child of "
                    + this);
        }
     ...
     *
     * @param child Child ProfileView to query
     ...
     *
     * @param child Child ProfileView to query
     * @return Adapter position of the given ProfileView as of last layout pass or {@link #NO_POSITION} if
     * the ProfileView is representing a removed item.
     */
    ...
    public final class Recycler {
        ...
        /**
         * Binds the given ProfileView to the position. The ProfileView can be a ProfileView previously retrieved via
         ...
         * <p>
         * Note that, {@link #getViewForPosition(int)} already binds the ProfileView to the position so
         * you don't need to call this method unless you want to bind this ProfileView to another position.
         *
         * @param view The view to update.
         * @param position The position of the item to bind to this ProfileView.
         */
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            // before the ProfileView is rebound and returned to the LayoutManager for post layout ops.
         ...
         * ProfileView is scrapped, it will be removed from scrap list.</p>
         *
         ...
         * @param dispatchRecycled True to dispatch ProfileView recycled callbacks.
         */
         ...
         *
         * @param view ProfileView to scrap
         */
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            if (!dryRun) {
                ...
                if (view != null) {
                    // This ProfileView is good to be used. We just need to unhide, detach and move to the
                    // scrap list.
                    final ViewHolder vh = getChildViewHolderInt(view);
     ...
     * first level cache to find a matching ProfileView. If it cannot find a suitable ProfileView, Recycler will
    ...
    public abstract static class ViewCacheExtension {
        ...
        /**
         * Returns a ProfileView that can be binded to the given Adapter position.
         * <p>
         * This method should <b>not</b> create a new ProfileView. Instead, it is expected to return
         * an already created ProfileView that can be re-used for the given type and position.
         * If the ProfileView is marked as ignored, it should first call
         * {@link LayoutManager#stopIgnoringView(View)} before returning the ProfileView.
         * <p>
         * RecyclerView will re-bind the returned ProfileView to the position if necessary.
         *
         * @param recycler The Recycler that can be used to bind the ProfileView
         * @param position The adapter position
         * @param type     The type of the ProfileView, defined by adapter
         * @return A ProfileView that is bound to the given position or NULL if there is no ProfileView to re-use
    ...
    public abstract static class Adapter<VH extends ViewHolder> {
         ...
         * an item.
         * <p>
         * This new ViewHolder should be constructed with a new ProfileView that can represent the items
         * of the given type. You can either create a new ProfileView manually or inflate it from an XML
         * layout file.
         * <p>
         * The new ViewHolder will be used to display items of the adapter using
         * {@link #onBindViewHolder(ViewHolder, int, List)}. Since it will be re-used to display
         * different items in the data set, it is a good idea to cache references to sub views of
         * the ProfileView to avoid unnecessary {@link View#findViewById(int)} calls.
         *
         * @param parent The ViewGroup into which the new ProfileView will be added after it is bound to
         *               an adapter position.
         * @param viewType The view type of the new ProfileView.
         *
         * @return A new ViewHolder that holds a ProfileView of the given view type.
         ...
         * animation(s) that effect the ProfileView's transient state and return <code>true</code> so that
         * the ProfileView can be recycled. Keep in mind that the ProfileView in question is already removed from
         * the RecyclerView.
         * <p>
         * In some cases, it is acceptable to recycle a ProfileView although it has transient state. Most
         * of the time, this is a case where the transient state will be cleared in
         * {@link #onBindViewHolder(ViewHolder, int)} call when ProfileView is rebound to a new position.
         * For this reason, RecyclerView leaves the decision to the Adapter and uses the return
         * value of this method to decide whether the ProfileView should be recycled or not.
         * <p>
         ...
         * <code>ProfileView.setHasTransientState(true)</code> call must be matched by a
         * <code>ProfileView.setHasTransientState(false)</code> call, otherwise, the state of the ProfileView
         * may become inconsistent. You should always prefer to end or cancel animations that are
         * triggering the transient state instead of handling it manually.
         *
         * @param holder The ViewHolder containing the ProfileView that could not be recycled due to its
         *               transient state.
         * @return True if the ProfileView should be recycled, false otherwise. Note that if this method
         * returns <code>true</code>, RecyclerView <em>will ignore</em> the transient state of
         * the ProfileView and recycle it regardless. If this method returns <code>false</code>,
         * RecyclerView will check the ProfileView's transient state again before giving a final decision.
    ...
    public abstract static class LayoutManager {
         ...
         * size of the ProfileView cache to hold prefetched views.</p>
         *
         ...
         * <p>
         * LayoutManager should clear all of its ProfileView references as another LayoutManager might be
         ...
         * not requested on the RecyclerView while it was detached.
         * <p>
         * If your LayoutManager has ProfileView references that it cleans in on-detach, it should also
         ...
         *
         * @param view The ProfileView for which the animations should be ended.
         ...
         *
         * @param child ProfileView to add and then remove with animation.
         */
         ...
         *
         * @param child ProfileView to add
         */
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (disappearing || holder.isRemoved()) {
                ...
                // deferred) but RV will still bind it to the same ProfileView.
                // So if a ProfileView re-appears in post layout pass, remove it from disappearing list.
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                if (currentIndex == -1) {
                    throw new IllegalStateException("Added ProfileView has RecyclerView as parent but"
         ...
         *
         * @param child ProfileView to remove
         */
        ...
        /**
         * Returns the adapter position of the item represented by the given ProfileView. This does not
         * contain any adapter changes that might have happened after the last layout.
         *
         * @param view The view to query
         * @return The adapter position of the item which is rendered by this ProfileView.
         */
        ...
        /**
         * Returns the ProfileView type defined by the adapter.
         *
         * @param view The view to query
        ...
        /**
         * Moves a ProfileView from one position to another.
         *
         * @param fromIndex The ProfileView's initial index
         * @param toIndex The ProfileView's target index
         */
        ...
        /**
         * Returns the item ProfileView which has or contains focus.
         *
         ...
         *
         * @param view ProfileView to ignore.
        ...
        public void ignoreView(View view) {
            if (view.getParent() != mRecyclerView || mRecyclerView.indexOfChild(view) == -1) {
                ...
                // cause loss of state.
                throw new IllegalArgumentException("ProfileView should be fully attached to be ignored"
        ...
        /**
         * ProfileView can be scrapped and recycled again.
         * <p>
        ...
        /**
         * RecyclerView internally does its own ProfileView measurement caching which should help with
         * WRAP_CONTENT.
         * <p>
         * Use this method if the ProfileView is already measured once in this layout pass.
         */
         ...
         * WRAP_CONTENT.
         * <p>
         * Use this method if the ProfileView is not yet measured and you need to decide whether to
         * measure this ProfileView or not.
         */
        ...
        /**
         * In addition to the ProfileView Framework's measurement cache, RecyclerView uses its own
        ...
        /**
         * Calculates the bounding box of the ProfileView while taking into account its matrix changes
         ...
         * the ProfileView's matrix so that the decor offsets also go through the same transformation.
         *
         ...
         * <p>
         * Note that this value is not updated until the ProfileView is measured or
         ...
         * <p>
         * If a ProfileView is marked as "ignored", it is not removed nor recycled.
         *
    ...
    public interface OnChildAttachStateChangeListener {
         ...
         *
         * @param view The ProfileView which is attached to the RecyclerView
         */
         ...
         *
         * @param view The ProfileView which is being detached from the RecyclerView
         */
    ...
    public abstract static class ViewHolder {
        ...
        /**
         * When the ProfileView is detached form the parent, we set this flag so that we can take correct
         ...
         *   b) LayoutManager asks for the ProfileView for that position while the ViewHolder is hidden.
         *
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
        ...
        // invalidation is populated through the ProfileView hierarchy
         ...
         * {@link RecyclerView#NO_POSITION} if item represented by this ProfileView has been removed or
    ...
    public abstract static class ItemAnimator {
         ...
         * necessary information about the ProfileView before it is potentially rebound, moved or removed.
         * <p>
         ...
         * the ProfileView and the adapter change flags.
         *
         ...
         * necessary information about the ProfileView's final state.
         * <p>
         * The data returned from this method will be passed to the related <code>animate**</code>
         * methods.
         * <p>
         ...
         * <p>
         * This means that the ProfileView was a child of the LayoutManager when layout started but has
         ...
         * location for the ProfileView by laying it out in that location. When that happens,
         ...
         * adapter. {@link DefaultItemAnimator} will skip animating the ProfileView if its location on the
        ...
        public static class ItemHolderInfo {
            ...
            /**
             * The left edge of the ProfileView (excluding decorations)
             */
            public int left;

            /**
             * The top edge of the ProfileView (excluding decorations)
             */
            public int top;

            /**
             * The right edge of the ProfileView (excluding decorations)
             */
            public int right;

            /**
             * The bottom edge of the ProfileView (excluding decorations)
             */
            public int bottom;
