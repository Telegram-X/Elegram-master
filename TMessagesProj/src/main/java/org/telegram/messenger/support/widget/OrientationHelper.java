...
/**
 * Helper class for LayoutManagers to abstract measurements depending on the ProfileView's orientation.
 * <p>
...
public abstract class OrientationHelper {
     ...
     * <p>
     * For example, for the horizontal helper, if a ProfileView's left is at pixel 20, has 2px left
     ...
     * <p>
     * For example, for the horizontal helper, if a ProfileView's right is at pixel 200, has 2px right
    ...
    /**
     * Returns the end of the ProfileView after its matrix transformations are applied to its layout
     * position.
     * <p>
     * This method is useful when trying to detect the visible edge of a ProfileView.
     * <p>
     * It includes the decorations but does not include the margins.
     *
     * @param view The view whose transformed end will be returned
     * @return The end of the ProfileView after its decor insets and transformation matrix is applied to
     * its position
     *
    ...
    /**
     * Returns the start of the ProfileView after its matrix transformations are applied to its layout
     * position.
     * <p>
     * This method is useful when trying to detect the visible edge of a ProfileView.
     * <p>
     ...
     * @return The start of the ProfileView after its decor insets and transformation matrix is applied to
     * its position
     *
     * @see RecyclerView.LayoutManager#getTransformedBoundingBox(View, boolean, Rect)
     */
    ...
    /**
     * Returns the space occupied by this ProfileView in the current orientation including decorations and
     * margins.
     *
     * @param view The view element to check
    ...
    /**
     * Returns the space occupied by this ProfileView in the perpendicular orientation including
     ...
     *
     * @param view   ProfileView to offset
